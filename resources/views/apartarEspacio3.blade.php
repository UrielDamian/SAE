		...
		<div class="x_content">
			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-12  form-group">
					...
					<input  title="Escribe el  nombre de tu evento" type="text" class="form-control uppercase" placeholder="Ejem: Clausura, practica 1...etc" id="nombreEvento" name="nombreEvento"   required >
...
$('.form_date').datetimepicker().on('hide', function(ev) {
	...
	let DisablehoursInicio=[0, 1, 2, 3, 4, 5, 6, 22, 23];//deshabilita horas en que PUEDE empezar el evento
	let DisablehoursFin=[0, 1, 2, 3, 4, 5, 6, 22, 23,21];//deshabilita horas en que PUEDE terminar el evento
